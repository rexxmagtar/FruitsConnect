    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                // As _EffectPower decreases, color appears from top to bottom
                // Transition point is at _EffectPower from bottom
                // If normalizedY <= _EffectPower, show grayscale; else show color
                // Add small epsilon to handle _EffectPower = 0.0 case correctly
                float grayscaleFactor = step(normalizedY, _EffectPower + 0.001);
